...
<div id="page-wrapper">
	...
	<div id="extra2" class="contain">
		...
		<div class="tbox1">
            ...
            <input class="inputfield" type="text" name="customername" placeholder="Name" >
			</div>
			<div class="padding-bottom">
				<label>Pick up location</label>    
            <input class="inputfield" type="text" name="pickuploc"  placeholder="Pick-up place" >
			</div>
			<div>
			<label>Pick up date</label>    
            <input class="inputfield" type="date" name="pickupdate" placeholder="dd/mm/yyyy" >
                <!--</label>-->
		</div>
		</div>
		<div class="tbox2">
        ...
        <input class="inputfield" type="text" name="dropoffloc" placeholder="Drop off place" >
			</div>
			<div class="padding-bottom">
				<label>Drop off date</label>    
            <input class="inputfield" type="date" name="dropoffdate" placeholder="dd/mm/yyyy" >
			</div>
			<div>
				<label>Car name</label> 
        <input class="inputfield" type="text" name="carname" placeholder="Car name" >
			</div>
		</div>
	</div>
	<div class = "butt">
